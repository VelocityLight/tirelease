...
INSERT INTO release_version (create_time, update_time, name, major, minor, patch, addition, owner, type, status, release_branch) VALUES (Now(), Now(), '5.0.7', 5, 0, 7, '', '尹苏', 'Patch', 'planned', "release-5.0");
...
INSERT INTO release_version (create_time, update_time, name, major, minor, patch, addition, owner, type, status, release_branch) VALUES (Now(), Now(), '5.1.5', 5, 1, 5, '', '尹苏', 'Patch', 'planned', "release-5.1");
...
INSERT INTO release_version (create_time, update_time, name, major, minor, patch, addition, owner, type, status, release_branch) VALUES (Now(), Now(), '5.2.4', 5, 2, 4, '', '尹苏', 'Patch', 'planned', "release-5.2");
...
INSERT INTO release_version (create_time, update_time, name, major, minor, patch, addition, owner, type, status, release_branch) VALUES (Now(), Now(), '5.4.1', 5, 4, 1, '', '尹苏', 'Patch', 'planned', "release-5.4");
